      ...
      <li>
        <div class="user-view">
          <div class="background">
            <img src="../img/dashadmin.png">
          </div>
          <a href="#user"><img class="circle" src="https://cdn5.vectorstock.com/i/1000x1000/01/69/businesswoman-character-avatar-icon-vector-12800169.jpg">Masyarakat</a>
          <br>
          <span class="white-text name"><a href="https://drive.google.com/file/d/1kFNqmqXgP8_y6jAPOLY30VmDYeipO8mG/view?usp=sharing">Tata cara penggunaan-></a>
