<div class="card" style="padding: 50px; width: 40%; margin: 0 auto; margin-top: 13%;">
	<h3 style="text-align: center;" class="cyan-text">Selamat Datang</h3>
	<form method="POST">
		...
		<input type="submit" name="login" value="Login" class="btn cyan" style="width: 100%;">
