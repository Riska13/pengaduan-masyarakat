...
<div class="card" style="padding: 50px; width: 25%; margin: 0 auto; margin-top: 7%;">
	<h3 style="text-align: center;" class="cyan-text">Daftar Akun Masyarakat</h3>
	<form method="POST">
		...
		<input type="submit" name="simpan" value="Daftar Disini!" class="btn cyan" style="width: 100%;">
